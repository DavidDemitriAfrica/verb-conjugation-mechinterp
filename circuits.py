...
# =============================================================================
# (Assuming the dataset is already generated by our previous code.)
# For example, our dataset is a list of dictionaries with keys like:
#   "prompt", "correct_verb", "incorrect_verb", "is_negated", "is_plural",
#   "subject", "prefix", "is_pronoun", "tense", "use_irregular", etc.
# =============================================================================
# (If needed, load or generate your dataset here; we assume it is in variable `dataset`.)

# For later use, we also define our lists of names and pronouns (should match dataset generation):
singular_names = [
